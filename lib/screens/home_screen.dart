  ...
  return Scaffold(
    body: _isLoading
        ...
        : Column(
            children: [
              Padding(
                padding: const EdgeInsets.only(top: 34.0, left: 24.0, right: 16.0),
                child: Column(
              ...
              Padding(
				...
				Padding(
  padding: const EdgeInsets.symmetric(horizontal: 35.0), // Sağ ve sol padding azaltıldı
  child: Container(
        ...
        Expanded(
          child: TextButton(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.add_circle_outline, color: Theme.of(context).colorScheme.onBackground), // Siyah renk
                SizedBox(width: 4),
                Text(
                  "Gelir Ekle",
                  style: TextStyle(color: Theme.of(context).colorScheme.onBackground), // Siyah renk
                ),
              ],
            ),
          ),
        ...
        Expanded(
          child: TextButton(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(Icons.remove_circle_outline, color: Theme.of(context).colorScheme.onBackground), // Siyah renk
                SizedBox(width: 4),
                Text(
                  "Gider Ekle",
                  style: TextStyle(color: Theme.of(context).colorScheme.onBackground), // Siyah renk
                        ...
                        Expanded(
                          child: ListView(
                            children: incomes.map((income) {
                              ...
                              return ListTile(
                                title: Text(parts[0], style: Theme.of(context).textTheme.bodyLarge),
                                subtitle: Text(parts[1], style: Theme.of(context).textTheme.bodyMedium),
                                trailing: Text(
                                  '₺${parts[2]}',
